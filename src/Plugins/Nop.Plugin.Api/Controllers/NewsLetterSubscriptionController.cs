...
namespace Nop.Plugin.Api.Controllers
{
    public class NewsLetterSubscriptionController : BaseApiController
    {
        ...
        public async Task<IActionResult> GetNewsLetterSubscriptionsAsync(NewsLetterSubscriptionsParametersModel parameters)
        {
            ...
            var newsLetterSubscriptions =await _newsLetterSubscriptionApiService.GetNewsLetterSubscriptionsAsync(parameters.CreatedAtMin, parameters.CreatedAtMax,
        ...
        public async Task<IActionResult> DeactivateNewsLetterSubscriptionAsync(string email)
        {
            ...
            var existingSubscription =await _newsLetterSubscriptionService.GetNewsLetterSubscriptionByEmailAndStoreIdAsync(email, (await _storeContext.GetCurrentStoreAsync()).Id);
