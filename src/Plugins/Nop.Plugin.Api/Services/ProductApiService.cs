...
namespace Nop.Plugin.Api.Services
{
    public class ProductApiService : IProductApiService
    {
        ...
        public  int GetProductsCountAsync(DateTime? createdAtMin = null, DateTime? createdAtMax = null,
        ...
        public Product GetProductBySku(string productSKU)
        {
            ...
            return _productRepository.Table.FirstOrDefault(product => product.Sku == productSKU && !product.Deleted);
        }
