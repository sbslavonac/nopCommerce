...
namespace Nop.Plugin.Api.Services
{
    ...
    {
        IList<Order> GetOrdersByCustomerIdAsync(int customerId);
        ...
        int GetOrdersCountAsync(DateTime? createdAtMin = null, DateTime? createdAtMax = null, OrderStatus? status = null,
