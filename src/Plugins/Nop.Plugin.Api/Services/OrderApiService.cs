...
namespace Nop.Plugin.Api.Services
{
    public class OrderApiService : IOrderApiService
    {
        ...
        public IList<Order> GetOrdersByCustomerIdAsync(int customerId)
        {
           ...
           int? storeId = null)
        {
            ...
            var apilist = new ApiList<Order>(query, page - 1, limit);
        ...
        public int GetOrdersCountAsync(DateTime? createdAtMin = null, DateTime? createdAtMax = null, OrderStatus? status = null,
