...
namespace Nop.Plugin.Api.Services
{
    public class ManufacturerApiService : IManufacturerApiService
    {
        ...
        public Manufacturer GetManufacturerByDescription(string description)
        {
            if (description == "")
                return null;

            return _manufacturerRepository.Table.FirstOrDefault(man => man.Description == description && !man.Deleted);
        }
