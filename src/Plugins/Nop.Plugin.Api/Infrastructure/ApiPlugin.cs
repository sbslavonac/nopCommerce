...
namespace Nop.Plugin.Api.Infrastructure
{
    public class ApiPlugin : BasePlugin, IAdminMenuPlugin
    {
        ...
        public override async Task UninstallAsync()
        {
            ...
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Api.Admin.Menu.Title");
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Api.Admin.Menu.Settings.Title");
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Api.Admin.Configure");
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Api.Admin.GeneralSettings");
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Api.Admin.EnableApi");
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Api.Admin.EnableApi.Hint");
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Api.Admin.Settings.GeneralSettingsTitle");
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.Api.Admin.Edit");
            var apiRole = await _customerService.GetCustomerRoleBySystemNameAsync(Constants.Roles.ApiRoleSystemName);
            if (apiRole != null)
            {
        ...
        public async void ManageSiteMap(SiteMapNode rootNode)
        {
