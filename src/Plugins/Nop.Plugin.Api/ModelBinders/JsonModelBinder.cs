...
namespace Nop.Plugin.Api.ModelBinders
{
    ...
    public class JsonModelBinder<T> : IModelBinder where T : class, new()
    {
        ...
        public JsonModelBinder(IJsonHelper jsonHelper, ILocalizationService localizationService, ILanguageService languageService, IRepository<Language> languageRepository)
        {
            ...
            var firstLanguage = _languageRepository.Table.FirstOrDefault();
        ...
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            if (bindingContext.ModelState.IsValid)
            {
              ...
              //  ValidateValueTypesAsync(bindingContext, propertyValuePairs).ConfigureAwait(true);
        ...
        private Dictionary<string, object> GetPropertyValuePairs(ModelBindingContext bindingContext)
        {
            ...
            if (bindingContext.ModelState.IsValid)
            {
                try
                {
                    ...
                    result = _jsonHelper.GetRequestJsonDictionaryFromStreamAsync(bindingContext.HttpContext.Request.Body, true).Result;
